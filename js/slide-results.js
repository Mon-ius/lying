...
function _slidePlotSender(divId, R, gt) {
  ...
  const layout = _layout({
    width: w, height: h,
    margin: { l: 16, r: 10, t: 6, b: 16 },
    xaxis: { gridcolor: gc, domain: [0.00, 0.14], tickfont: { size: 9 }, fixedrange: true, automargin: true },
    yaxis: { gridcolor: gc, range: [0, 1.05], title: { text: 'P(truth)', font: { size: 9 } }, ticklabelstandoff: 3, automargin: true },
    xaxis2: { gridcolor: gc, domain: [0.24, 1.00], range: [-0.02, 1.02], title: { text: 'P(truth)', font: { size: 9 } }, automargin: true },
...
function _slidePlotTrend(divId, R) {
  ...
  const layout = _layout({
    ...
    xaxis:  { gridcolor: gc, domain: [0.00, 0.44], title: { text: 'Round', font: { size: 9 } }, dtick: 1, automargin: true },
    yaxis:  { gridcolor: gc, range: [-0.02, 1.02], title: { text: 'P(m=1|θ₁=0)', font: { size: 9 } }, automargin: true },
    xaxis2: { gridcolor: gc, domain: [0.56, 1.00], title: { text: 'Round', font: { size: 9 } }, dtick: 1, anchor: 'y2', automargin: true },
    yaxis2: { gridcolor: gc, range: [-0.02, 1.02], side: 'right', title: { text: 'P(m=1|θ₁=1)', font: { size: 9 }, standoff: 6 }, anchor: 'x2', automargin: true },
    legend: { x: 0.5, y: 1.16, xanchor: 'center', orientation: 'h', font: { size: 9 }, bgcolor: 'rgba(0,0,0,0)' },
    annotations: [
      { text: '<b>BT</b>', xref: 'paper', yref: 'paper', x: 0.22, y: 1.06, showarrow: false, font: { size: 10, color: annColor } },
      { text: '<b>GL</b>', xref: 'paper', yref: 'paper', x: 0.78, y: 1.06, showarrow: false, font: { size: 10, color: annColor } },
    ],
  });
  Plotly.react(divId, traces, layout, _cfg);
}
