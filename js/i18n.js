...
const I18N = {
  en: {
    ...
    'chart.params':'Utility Parameter Distributions',
    'chart.joint':'Joint (c<sub>l</sub>, c<sub>d</sub>) Distribution',
    'chart.stratbt':'Strategy Distribution \u2014 BT','chart.stratgl':'Strategy Distribution \u2014 GL',
    'chart.types':'Agent Type Proportions',
    'chart.regions':'Equilibrium Regions (c<sub>l</sub> vs c<sub>d</sub>)',
  ...
  zh: {
    ...
    'chart.params':'\u6548\u7528\u53c2\u6570\u5206\u5e03',
    'chart.joint':'(c<sub>l</sub>, c<sub>d</sub>) \u8054\u5408\u5206\u5e03',
    'chart.stratbt':'\u7b56\u7565\u5206\u5e03 \u2014 BT','chart.stratgl':'\u7b56\u7565\u5206\u5e03 \u2014 GL',
    'chart.types':'\u667a\u80fd\u4f53\u7c7b\u578b\u6bd4\u4f8b',
    'chart.regions':'\u5747\u8861\u533a\u57df (c<sub>l</sub> vs c<sub>d</sub>)',
    'log.title':'\u535a\u5f08\u65e5\u5fd7\u6837\u672c',
    'arch.title':'\u535a\u5f08\u7cfb\u7edf\u67b6\u6784',
